...
class _ProductsTabState extends State<_ProductsTab> {
  ...
  Future<void> addProduct([Map? edit]) async {
    ...
    int? catId = edit?['category_id'] != null
        ? (edit?['category_id'] as num).toInt()
        : null;
    List allCats = [];
    List allAttrs = [];
    ...
    if (edit != null && catId != null) {
      for (final a in allAttrs.where(
        (a) =>
            (a['category_id'] as num).toInt() == catId &&
            !['size', 'color'].contains(a['key']),
      )) {
        attrCtrls[a['key']] = TextEditingController(
          text: '${(edit['attributes'] ?? {})[a['key']] ?? ''}',
        );
      }
    }
                  ...
                  children: [
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: SizedBox(
                                    width: 72,
                                    height: 72,
                                    child: productImageBox(u, base: Api.base),
                                  ),
                                ),
                                Positioned(
                                  top: 2,
                    ...
                    DropdownButtonFormField<int?>(
                      ...
                      onChanged: (v) => setS(() {
                        ...
                        attrCtrls.clear();
                        for (final a in allAttrs.where(
                          (a) => (a['category_id'] as num).toInt() == catId,
                        )) {
                          attrCtrls[a['key']] = TextEditingController();
                        }
                      }),
                          ...
                          children: [
                            Expanded(
                              child: TextField(
                                ...
                                decoration: const InputDecoration(
                                  labelText:
                                      'اللون (أحمر/أسود) — اتركه فاضي لو ماكو',
                                ),
            ...
            Row(
              children: [
                Text(
                  ...
                  style: AppType.style(15, weight: FontWeight.w900),
                ),
                const Spacer(),
                SolidBtn(
                  label: '+ منتج',
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    '${p['name'] ?? ''}',
                    style: AppType.style(11, weight: FontWeight.w800),
                    maxLines: 2,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: hasOffer ? AppColors.accent : AppColors.line,
                        width: 1,
                      ),
                    ),
                    child: GestureDetector(
                      ...
                      child: Text(
                        ...
                        style: AppType.style(
                          9.5,
                          color: hasOffer ? AppColors.accent : AppColors.muted,
...
class _OfferBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: dark ? Colors.black87 : AppColors.accent,
        borderRadius: BorderRadius.circular(8),
      ),
      child: Text(
        label,
              ...
              child: Column(
                children: [
                  ...
                  SolidBtn(
                    ...
                    onTap: () async {
                      try {
                        await Api.post('/api/vendor/wallet/withdraw', {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'اختر باقة الإعلان',
                    style: AppType.style(13, weight: FontWeight.w800),
                  ),
                  const SizedBox(height: 8),
                  ...packages.map(
                    (p) => RadioListTile<int>(
                      ...
                      subtitle: Text(
                        formatMoney(p['price']),
                        style: AppType.style(12, color: AppColors.accent),
                      ),
                      value: p['id'],
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          TextButton.icon(
                            onPressed: () =>
                                pickAndSet(logo, 'قصّ الشعار ✂️', 1),
                            icon: const Icon(
                              Icons.add_photo_alternate_rounded,
                              size: 17,
                            ),
                      ...
                      SizedBox(
                        height: 56,
                        width: double.infinity,
                        child: productImageBox(logo.text, base: Api.base),
                      ),
                      const SizedBox(height: 10),
                      // ── صورة الغلاف ──
                      Row(
                        children: [
                          ...
                          TextButton.icon(
                            onPressed: () =>
                                pickAndSet(cover, 'قصّ الغلاف ✂️', 16 / 9),
                            icon: const Icon(
                              Icons.add_photo_alternate_rounded,
                              size: 17,
                            ),
                      ...
                      OutlinedButton.icon(
                        ...
                        onPressed: () async {
                          final picked = await Navigator.push<Object?>(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  PickMapScreen(lat: slat, lng: slng),
                            ),
                          );
              ...
              child: Row(
                children: [
                  ...
                  Switch(
                    ...
                    onChanged: (v) async {
                      try {
                        await Api.post('/api/vendor/store/vacation', {
                          'on_vacation': v,
                        });
                        setState(() => s['on_vacation'] = v);
                        toast(
                          context,
                          v ? 'المتجر ويا إجازة' : 'المتجر رجع يشتغل',
                        );
                      } on ApiException catch (e) {
                        toast(context, e.message, error: true);
                      }
                ...
                child: Column(
                  children: [
                    TextField(
                      controller: code,
                      decoration: const InputDecoration(
                        labelText: 'كود الكوبون (مثال: SAVE10)',
                      ),
                    ),
                    const SizedBox(height: 10),
                    SegmentedButton<bool>(
                      ...
                      onSelectionChanged: (s) =>
                          setS2(() => isPercent = s.first),
                    ),
                    const SizedBox(height: 10),
                    TextField(
                      controller: ff,
                      decoration: InputDecoration(
                        labelText: isPercent ? 'الخصم %' : 'الخصم (د.ع)',
                      ),
                      keyboardType: TextInputType.number,
                    ),
                    const SizedBox(height: 10),
                    ...
                    TextField(
                      controller: maxD,
                      decoration: const InputDecoration(
                        labelText: 'سقف الخصم (د.ع) — 0 بدون سقف',
                      ),
                      keyboardType: TextInputType.number,
                    ),
                    const SizedBox(height: 16),
                      ...
                      onTap: () async {
                        try {
                          await Api.post('/api/vendor/coupons', {
                            'code': code.text,
                            if (isPercent)
                              'percent': int.tryParse(ff.text) ?? 0,
        ...
        children: [
          ...
          if (loading)
            ...
            const Padding(
              ...
              child: Text(
                'لا كوبونات — انشئ أول كوبون لعملائك',
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'أسئلة الزبائن 📩 (${questions.length})',
                    style: AppType.style(13.5, weight: FontWeight.w900),
                  ),
                ),
              ],
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            '${q['user_name']} · ${q['product_name']}',
                            style: AppType.style(10.5, color: AppColors.muted),
                          ),
                          const SizedBox(height: 3),
                          Text(
                            '${q['question']}',
                            style: AppType.style(12, weight: FontWeight.w700),
                          ),
                        ],
                      ),
                    ),
    ...
    if (refunds.isEmpty)
      return const GlassCard(
        child: EmptyState(
          icon: '↩️',
          title: 'لا مرتجعات',
          sub: 'حالات الإرجاع من الزبائن تظهر هنا',
        ),
      );
    return Column(
      children: [
