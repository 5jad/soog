  ...
  return (
    <Modal open={open} onClose={onClose}>
      ...
      <div className="note" style={{ marginTop: 13, lineHeight: 2 }}>
        📲 عند إنشاء حساب جديد الرمز السري يوصلك عبر بوت التليجرام <b>@soog_otp_bot</b> — ربطه مرة واحدة من شاشة الدخول أيضاً في <a href="/download" style={{ color: 'var(--primary)', fontWeight: 800 }}>تطبيق الجوال</a>.
      </div>
    </Modal>
  );
}