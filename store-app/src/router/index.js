...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/outfit/:id', name: 'outfit', component: () => import('../views/OutfitView.vue'), meta: { title: 'نسّق لي ✨' } },
    ...
    { path: '/search', name: 'search', component: () => import('../views/SearchView.vue'), meta: { title: 'بحث وفئات' } },
